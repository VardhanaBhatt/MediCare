 ...
 * @author Karishma
 */
public class SystemAdminHomeJPanel extends javax.swing.JPanel {
    ...
    public SystemAdminHomeJPanel(JPanel mainContainer, EcoSystem system, DB4OUtil dB4OUtil, UserAccount userAccount) {
        initComponents();
        ...
        SystemAdminWorkAreaJPanel sawajp = new SystemAdminWorkAreaJPanel(userProcessContainer,system);
        userProcessContainer.add("sawajp",sawajp);
    ...
    private void btnViewAreaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewAreaActionPerformed
        // TODO add your handling code here:
        CardLayout  cardLayout = (CardLayout) userProcessContainer.getLayout();
        SystemAdminViewAreaJPanel savjp = new SystemAdminViewAreaJPanel(userProcessContainer, system, dB4OUtil, userAccount);
        userProcessContainer.add("savjp",savjp);
        cardLayout.next(userProcessContainer);
